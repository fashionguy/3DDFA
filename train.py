...
args = None
lr = None
arch_choices = ['mynet', 'mobilenet_2', 'mobilenet_1', 'mobilenet_075', 'mobilenet_05', 'mobilenet_025']
...
def parse_args():
    ...
    parser.add_argument('--root', default='/home/shishang/Desktop/datasets/ALFW/train_aug_120x120')
    ...
    parser.add_argument('--param-fp-train', default='../train.configs/param_all_norm.pkl', type=str)
    parser.add_argument('--param-fp-val', default='../train.configs/param_all_norm_val.pkl')
